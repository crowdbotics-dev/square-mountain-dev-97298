...
## Project Structure
    ...
    ├── square_mountain_dev_97298  # Django project configurations
...
1. Clone this repo and `cd square_mountain_dev_97298`
...
2. Clone this repo and `cd square_mountain_dev_97298`
